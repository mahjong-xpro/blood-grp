...
/// Calculate score from fan count: 1000 * 2^(fan-1), capped at 6 fan = 32000
...
mod tests {
    ...
    fn test_score_table() {
        ...
        assert_eq!(calc_score(6), 32000);
        assert_eq!(calc_score(7), 32000); // capped at 6
        assert_eq!(calc_score(10), 32000);
        assert_eq!(calc_score(u8::MAX), 32000); // extreme cap
    }
}

...
$(function () {
  ...
  // Removed allActions loop for dynamic playback
...
// Expose variables for external control
window.kyokus = kyokus;
window.currentKyokuId = currentKyokuId;
window.currentActionId = currentActionId;
window.currentViewpoint = currentViewpoint;
window.renderCurrentAction = renderCurrentAction;
window.loadAction = loadAction;
window.paiToImageUrl = paiToImageUrl;
window.parsePai = parsePai;

...
### Phase 3: 进攻/防守平衡 (Step 355k — ~500k) [当前阶段]
...
| 参数 | Phase 1 (完成) | Phase 2 (完成) | Phase 3 (当前) | Phase 4 | Phase 5 |
|------|---------------|---------------|----------------|---------|---------|
...
| final LR | 1e-4 | 1e-4 | **5e-5** | 1e-5 | 1e-5 |
| warmup | 2000 | 2000 | **3000** | 5000 | 5000 |
...
| Phase 3 [当前] | 355k–500k | ~20h | ~70h (~3天) |
